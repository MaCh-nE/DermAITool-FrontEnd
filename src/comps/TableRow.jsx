...
const TableRow = ({upload, setClick}) => {
  ...
  return (
    <tr onClick={() => setClick([true, upload])} className="select-none cursor-pointer h-[148px] bg-white border-b dark:bg-slate-900 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
        <td className="p-4">
